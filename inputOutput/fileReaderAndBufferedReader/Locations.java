package inputOutput.fileReaderAndBufferedReader;
...
//        Below Try method uses FileReader method to get the data.
...
//        Try-with-Resources exception handling for one fileWriter
//
//        try (FileWriter locFile = new FileWriter("locations.txt")) {
//            for (Location location :
//                    locations.values()) {
